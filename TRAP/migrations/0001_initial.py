# Generated by Django 2.1.4 on 2019-05-02 14:32
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('windv', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True)),
                ('windv9', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True)),
                ('soiltem', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True)),
                ('soiltem9', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True)),
                ('radiation', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True)),
                ('rad9', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True)),
                ('bday9', models.IntegerField(blank=True, null=True)),
                ('bdaydate', models.DateField(blank=True, null=True)),
                ('bmon', models.IntegerField(blank=True, null=True)),
                ('wlmpl', models.IntegerField(blank=True, null=True)),
                ('nfmmg', models.IntegerField(blank=True, null=True)),
                ('fsq', models.IntegerField(blank=True, null=True)),
                ('cnusq2', models.IntegerField(blank=True, null=True)),
