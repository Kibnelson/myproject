...
class Intbursary(models.Model):
	...
	degree_1 = models.CharField(max_length=200, blank =True)
	f_o_study_1 = models.CharField(max_length=200, blank = True)
	major_sub_1 = models.CharField(max_length=200, blank = True)
	institution_1 = models.CharField(max_length=200, blank = True)
	year_obtained_1 = models.CharField(max_length=10, blank =True)
	degree_2 = models.CharField(max_length=200, blank =True)
	f_o_study_2 = models.CharField(max_length=200, blank = True)
	major_sub_2 = models.CharField(max_length=200, blank = True)
	institution_2 = models.CharField(max_length=200, blank = True)
	year_obtained_2 = models.CharField(max_length=10, blank = True)
	degree_3 = models.CharField(max_length=200, blank =True)
	f_o_study_3 = models.CharField(max_length=200, blank = True)
	major_sub_3 = models.CharField(max_length=200, blank = True)
	institution_3 = models.CharField(max_length=200, blank = True)
	year_obtained_3 = models.CharField(max_length=10, blank=True)
	degree_4 = models.CharField(max_length=200, blank =True)
	f_o_study_4 = models.CharField(max_length=200, blank = True)
	major_sub_4 = models.CharField(max_length=200, blank = True)
	institution_4 = models.CharField(max_length=200, blank = True)
	year_obtained_4 = models.CharField(max_length=10, blank= True)
